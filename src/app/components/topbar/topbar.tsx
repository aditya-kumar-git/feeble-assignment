    ...
    >
      <div className="element-shadow w-[95vw] md:w-[62.5vw] bg-white rounded-[200px] py-[12px] md:py-[0.9vw] px-[12px] md:px-[1.2vw] flex items-center justify-between">
        <Image
          src={CoupIcon.src}
          alt="Coup Icon"
          className="w-[50px] md:w-[5.5vw]"
          width={107}
          height={34}
        />
        <nav>
          <ul className="flex items-center gap-[0.7vw] text-[10px] md:text-[0.8vw] font-medium">
        ...
        <button className="element-shadow-hover relative overflow-hidden bg-[var(--primary)] text-white text-[10px] md:text-[0.8vw] font-medium px-[8px] md:px-[0.9vw] py-[4px] md:py-[0.5vw] flex items-center justify-center rounded-[100px] cursor-pointer transition-colors duration-300 group">
          <span
